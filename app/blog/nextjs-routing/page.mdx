...
If you haven't used the App Router yet and you also like watching paint dry, then you're in the right place.<br />
I'm joking, <Wobbly>kind of</Wobbly>.
...
Brace yourself for some thrilling file naming conventions. I know, contain your excitement.
...
<Spacer size="small" />
This approach allows for <Italic>nested layouts</Italic>, giving you control
over the structure of your app. It's like Russian nesting dolls, but for your
UI.
...
A dynamic segment is created by wrapping a folder's name in square brackets: `[folderName]`. For example, `[id]` or `[slug]`.
...
- <Underline>
    Use when you want to handle both root and nested paths in one component
  </Underline>
...
Because sometimes, you just can't decide if you want to catch them all or not, and I'm not talking about Pokémon.
...
Parallel routes allow you to render multiple pages simultaneously within the same layout. This is useful for creating UIs with independent navigation, such as dashboards or social media feeds.<Highlighter>
...
- Use the `@folder` convention to create named slots (e.g., `@dashboard`, `@feed`)
  <Spacer size="small" />
- <Underline>Slots are passed as props to the parent layout</Underline>
  <Spacer size="small" />
