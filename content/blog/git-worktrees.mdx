...
The stash/unstash workflow is clunky. You're mid-feature, need to check something on another branch, so you stash, switch, do the thing, switch back, unstash. It works but it's annoying. Git worktrees fix this, and I wish I learned about them sooner.
...
Not every situation needs a worktree. Here's when they make sense:
...
If your working directory is clean and it's a quick task, normal checkout is fine. Worktrees add a bit of overhead. But for anything where you don't want to lose your current context, they're worth it.
...
And with AI tools increasingly running tasks in parallel, I think worktrees are going from "nice to know" to pretty essential. Worth learning now.
